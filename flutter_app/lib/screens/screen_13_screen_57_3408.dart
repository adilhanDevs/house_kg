// GENERATED from screens/Components.bundle.js — figma node StartScreen13.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Экран 57:3408 — 375.0×812.0
class Screen13Screen573408 extends StatelessWidget {
  const Screen13Screen573408({super.key});
                ...
                child: Row(
                  ...
                  children: [
                    FigText(
                      noWrap: true,
                      span: 
                        TextSpan(text: 'Связаться с собственником', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xffffffff)))
                      ,
                    ),
                  ],
                )
