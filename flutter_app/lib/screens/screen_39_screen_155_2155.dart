// GENERATED from screens/Components.bundle.js — figma node StartScreen38.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Экран 155:2155 — 375.0×812.0
class Screen39Screen1552155 extends StatelessWidget {
  const Screen39Screen1552155({super.key});
        ...
        children: [
          ...
          Positioned(
            ...
            child: FigText(
              ...
              height: 25.0,
              span: 
                TextSpan(text: 'Задания', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, letterSpacing: -0.21, color: const Color(0xff000000)))
              ,
            )
          ),
          Positioned(
            ...
            child: FigText(
              ...
              height: 20.0,
              span: 
                TextSpan(text: 'После покупки VIP', style: figStyle(fontSize: 17.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
              ,
            )
          ),
          Positioned(
              ...
              child: FigOverflow(
                ...
                child: Row(
                  ...
                  children: [
                    FigText(
                      span: 
                        TextSpan(text: 'Сату́рн — шестая планета \nпо удалённости от слонца', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xff000000)))
                      ,
                    ),
                    FigBox(
                      height: 32.0,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FigText(
                              ...
                              height: 16.0,
                              span: 
                                TextSpan(text: '+200', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 600, height: 1.0, letterSpacing: -0.15, color: const Color(0xff4dba17)))
                              ,
                            ),
                          ],
                        )
