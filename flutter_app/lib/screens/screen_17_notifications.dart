// GENERATED from screens/Components.bundle.js — figma node StartScreen17.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Уведомления — 375.0×812.0
class Screen17Notifications extends StatelessWidget {
  const Screen17Notifications({super.key});
        ...
        children: [
          ...
          Positioned(
            ...
            child: FigText(
              ...
              height: 25.0,
              span: 
                TextSpan(text: 'Уведомления', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, letterSpacing: -0.21, color: const Color(0xff000000)))
              ,
            )
          ),
          Positioned(
              ...
              child: FigOverflow(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            FigBox(
                              child: FigOverflow(
                                ...
                                child: Row(
                                  ...
                                  spacing: 8.0,
                                  children: [
                                    FigBox(width: 48.0, height: 48.0, radius: 8.0, bgImage: const FigBgImage('assets/figma/2e62acec850fa8b9.jpg')),
                                    FigBox(
                                      width: 139.0,
                                      child: FigOverflow(
                                        alignment: const Alignment(-1.0, -1.0),
                                                  ...
                                                  Positioned(
                                                    ...
                                                    child: Transform(
                                                      ...
                                                      child: FigSvg(
                                                        ...
                                                        shapes: const [FigShape(d: _p8, fill: Color(0xff000000))],
                                                      )
                                                      ,
                                                    )
                                                  ),
                    ...
                    FigSvg(
                      width: 326.0, height: 1.0,
                      vbLeft: 0.0, vbTop: -0.5, vbWidth: 326.0, vbHeight: 1.0,
                      shapes: const [FigShape(d: _p9, fill: Color(0xffd9d9d9))],
                    ),
                    FigBox(
                      width: 326.0,
                      child: FigOverflow(
                            ...
                            FigBox(
                              child: FigOverflow(
                                ...
                                child: Row(
                                  ...
                                  spacing: 8.0,
                                  children: [
                                    FigBox(width: 48.0, height: 48.0, radius: 8.0, bgImage: const FigBgImage('assets/figma/f36bc748a320b1d4.jpg')),
                                    FigBox(
                                      width: 139.0,
                                      child: FigOverflow(
                                        alignment: const Alignment(-1.0, -1.0),
...
const String _p9 =
    'M 0 -0.5 L 0 0 L 326 0 L 326 -0.5 L 326 -1 L 0 -1 L 0 -0.5 Z';
