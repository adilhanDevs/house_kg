// GENERATED from screens/Components.bundle.js — figma node StartScreen39.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Экран 155:2313 — 375.0×792.0
class Screen40Screen1552313 extends StatelessWidget {
  const Screen40Screen1552313({super.key});

  static const double designWidth = 375.0;
  static const double designHeight = 792.0;

  /// Where the mockup draws the tab bar on this screen.
  static const Offset tabBarAt = Offset(0.0, 708.0);
                              ...
                              child: FigOverflow(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FigText(
                                      span: 
                                        TextSpan(style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 600, height: 1.333, color: const Color(0xff7d7d7d)), children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            FigText(
                              noWrap: true,
                              span: 
                                TextSpan(text: 'Изменить публикацию', style: figStyle(fontSize: 12.0, family: FigFont.display, weight: 600, height: 1.833, color: const Color(0xffffffff)))
                              ,
                            ),
                          ],
                        )
                        ...
                        child: Row(
                          ...
                          children: [
                            FigText(
                              noWrap: true,
                              span: 
                                TextSpan(text: 'Деактивировать', style: figStyle(fontSize: 12.0, family: FigFont.display, weight: 600, height: 1.833, color: const Color(0xffffffff)))
                              ,
                            ),
                          ],
                        )
