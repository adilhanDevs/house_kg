// GENERATED from screens/Components.bundle.js — figma node StartScreen26.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Экран 64:1365 — 375.0×812.0
class Screen27Screen641365 extends StatelessWidget {
  const Screen27Screen641365({super.key});
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            FigText(
                                              width: 227.0,
                                              span: 
                                                TextSpan(text: '3 из 5 дней', style: figStyle(fontSize: 17.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                                              ,
                                            ),
                                            FigText(
                                              width: 227.0,
                                              span: 
                                                TextSpan(text: 'Освоено 170 сом из 240 сом', style: figStyle(fontSize: 17.0, family: FigFont.display, weight: 500, height: 1.0, color: const Color(0xffbababa)))
                                              ,
                                            ),
                                          ],
                                        )
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    child: FigText(
                                      ...
                                      height: 14.0,
                                      span: 
                                        TextSpan(text: 'Изменить', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe07d7d7d)))
                                      ,
                                    )
                                  ),
                                ],
                        ...
                        child: Column(
                          ...
                          children: [
                            FigText(
                              width: 339.0,
                              span: 
                                TextSpan(text: 'Просмотр статистики', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                              ,
                            ),
                            FigText(
                              width: 339.0,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: '670', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                                      ,
                                    ),
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: 'Просмотров', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.538, color: const Color(0xff7d7d7d)))
                                      ,
                                    ),
                                  ],
                                )
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: '32', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                                      ,
                                    ),
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: 'Лида', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.538, color: const Color(0xff7d7d7d)))
                                      ,
                                    ),
                                  ],
                                )
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: '150', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                                      ,
                                    ),
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: 'Клиентам отправлено', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.538, color: const Color(0xff7d7d7d)))
                                      ,
                                    ),
                                  ],
                                )
                                                                ...
                                                                children: [
                                                                  Positioned(
                                                                    ...
                                                                    child: FigSvg(
                                                                      ...
                                                                      shapes: const [FigShape(d: _p4, fill: Color(0xff484848))],
                                                                    )
                                                                  ),
                                                                  Positioned(
                                                                    left: 3.818, top: 0.0,
                                  ...
                                  Positioned(
                                    ...
                                    child: Align(
                                      child: FigText(
                                        ...
                                        height: 14.0,
                                        span: 
                                          TextSpan(text: 'Изменить объявление', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe07d7d7d)))
                                        ,
                                      )
                                      ,
                                    )
