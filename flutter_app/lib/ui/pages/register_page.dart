...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _onNext() async {
    ...
    if (phone.isEmpty || name.isEmpty || password.isEmpty) {
      _complain(
        'Заполните телефон, имя и пароль',
      );
...
Widget build(BuildContext context) {
  return PopScope(
    ...
    child: Scaffold(
      ...
      // Отключаем автоматическое изменение размеров при появлении клавиатуры
      // — чтобы не было прокрутки и контент не сдвигался.
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    'Мы пришлём код подтверждения, а войти '
                    'потом можно будет по паролю.',
                    style: figStyle(
                      fontSize: 15.0,
                      family: FigFont.display,
                      weight: 500,
            ...
            // Небольшой промежуток после кнопки.
              ...
              child: ClipRect(
                child: Align(
                  ...
                  child: Image.asset(
                    ...
                    // не увеличивая высоту страницы.
                    fit: BoxFit.cover,

                    // Верх изображения остаётся приоритетным.
