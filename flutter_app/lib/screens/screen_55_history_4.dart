...
/// История трат · 4 — 375.0×812.0
class Screen55History4 extends StatelessWidget {
  const Screen55History4({super.key});
                        ...
                        children: [
                          Positioned(
                            ...
                            child: FigText(
                              ...
                              height: 14.0,
                              span: 
                                TextSpan(text: 'Бонусы', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe0ea812e)))
                              ,
                            )
                          ),
                        ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: '+300 кирпичей (бонус за квест)', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xff4dba17)))
                                      ,
                                    ),
                                  ],
                                )
