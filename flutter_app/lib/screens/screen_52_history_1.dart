...
/// История трат · 1 — 375.0×812.0
class Screen52History1 extends StatelessWidget {
  const Screen52History1({super.key});
                        ...
                        children: [
                          Positioned(
                            ...
                            child: FigText(
                              ...
                              height: 14.0,
                              span: 
                                TextSpan(text: 'Все операции', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe0ea812e)))
                              ,
                            )
                          ),
                        ],
                        ...
                        children: [
                          Positioned(
                            ...
                            child: FigText(
                              ...
                              height: 14.0,
                              span: 
                                TextSpan(text: 'Списание', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe07d7d7d)))
                              ,
                            )
                          ),
                        ],
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            FigText(
                                              width: 215.0,
                                              span: 
                                                TextSpan(text: '+12 000 сом (12 000 кирпичей)', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xff4dba17)))
                                              ,
                                            ),
                                          ],
                                        )
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            FigText(
                                              noWrap: true,
                                              span: 
                                                TextSpan(text: '+1 200 кирпичей (бонус за пополнение)', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xff4dba17)))
                                              ,
                                            ),
                                          ],
                                        )
                        ...
                        child: Column(
                          ...
                          children: [
                            FigText(
                              width: 159.0,
                              span: 
                                TextSpan(text: '20 августа', style: figStyle(fontSize: 17.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                              ,
                            ),
                            FigBox(
                              width: 159.0,
