...
from apps.catalog.enums import Currency, ListingStatus, MediaKind, MediaStatus, PropertyKind
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        district_asanbay, _ = District.objects.get_or_create(
            city=city, name="Асанбай", slug="asanbay", latitude=42.8, longitude=74.6
        )
        district_center, _ = District.objects.get_or_create(
            city=city, name="Центр", slug="center", latitude=42.87, longitude=74.59
        )
