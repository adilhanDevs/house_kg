// GENERATED from screens/Components.bundle.js — figma node StartScreen16.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Вам понравилось — 375.0×812.0
class Screen16Liked extends StatelessWidget {
  const Screen16Liked({super.key});
        ...
        children: [
          ...
          Positioned(
            ...
            child: FigText(
              ...
              height: 25.0,
              span: 
                TextSpan(text: 'Вам понравилось', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, letterSpacing: -0.21, color: const Color(0xff000000)))
              ,
            )
          ),
          Positioned(
...
const String _p7 =
    'M 0 3.896 C 0 6.643 2.429 9.346 6.267 11.668 C 6.409 11.752 6.614 11.842 6.756 11.842 C 6.899 11.842 7.103 11.752 7.253 11.668 C 11.084 9.346 13.513 6.643 13.513 3.896 C 13.513 1.612 11.86 0 9.655 0 C 8.396 0 7.376 0.568 6.756 1.438 C 6.151 0.574 5.117 0 3.858 0 C 1.653 0 0 1.612 0 3.896 Z M 6.383 3.724 C 6.383 2.008 5.641 4.499 7.219 4.499 C 8.498 4.499 5.858 1.793 6.294 2.438 C 6.477 2.696 6.72 3.724 6.883 3.724 C 7.046 3.724 7.022 2.69 7.219 2.438 C 7.689 1.806 5.021 5.724 6.294 5.724 C 7.872 5.724 8.883 2.008 8.883 3.724 C 8.883 6.123 10.227 1.431 7.383 3.224 C 7.315 3.269 6.648 4.224 6.62 4.224 C 6.593 4.224 7.046 3.941 6.984 3.896 C 4.134 2.103 6.383 6.123 6.383 3.724 Z';
