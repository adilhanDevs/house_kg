// GENERATED from screens/Components.bundle.js — figma node StartScreen5.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Добро пожаловать — 375.0×812.0
class Screen05Welcome extends StatelessWidget {
  const Screen05Welcome({super.key});
    ...
    return FigBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: 116.0, top: 717.0,
            child: FigText(
              noWrap: true,
              width: 143.0,
              height: 20.0,
              span: 
                TextSpan(text: 'Зарегистрироваться', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xffea812e)))
              ,
            )
          ),
          Positioned(
            left: 118.0, top: 753.0,
            child: FigText(
              noWrap: true,
              width: 140.0,
              height: 20.0,
              span: 
                TextSpan(text: 'Режим исполнителя', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xff7d7d7d)))
              ,
            )
          ),
          Positioned(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: FigText(
                                        ...
                                        height: 22.0,
                                        span: 
                                          TextSpan(text: 'Номер телефона', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 400, height: 1.467, letterSpacing: -0.43, color: const Color(0x993c3c43)))
                                        ,
                                      )
                                    ),
                                  ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: 'Войти', style: figStyle(fontSize: 17.0, family: FigFont.display, weight: 600, height: 1.294, color: const Color(0xffffffff)))
                                      ,
                                    ),
                                  ],
                                )
