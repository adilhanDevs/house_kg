// GENERATED from screens/Components.bundle.js — figma node StartScreen34.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Экран 155:1329 — 375.0×795.0
class Screen35Screen1551329 extends StatelessWidget {
  const Screen35Screen1551329({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    FigText(
                      width: 335.0,
                      span: 
                        TextSpan(text: 'Добавить/изменить фотографии', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                      ,
                    ),
                    FigText(
                      width: 335.0,
                                  ...
                                  Positioned(
                                    ...
                                    child: Opacity(
                                      ...
                                      child: FigSvg(
                                        ...
                                        shapes: const [FigShape(d: _p3, fill: Color(0xffec8d43))],
                                      ),
                                    )
                                  ),
                                  Positioned(
                                    ...
                                    child: FigSvg(
                                      ...
                                      shapes: const [FigShape(d: _p4, fill: Color(0xffec8d43))],
                                    )
                                  ),
                                  Positioned(
                                    ...
                                    child: FigSvg(
                                      ...
                                      shapes: const [FigShape(d: _p5, fill: Color(0xffec8d43))],
                                    )
                                  ),
                                ],
                              )
                      ...
                      child: FigOverflow(
                        ...
                        child: Column(
                          ...
                          children: [
                            FigText(
                              span: 
                                TextSpan(text: 'Добавить фото', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 600, height: 1.0, letterSpacing: -0.15, color: const Color(0xff000000)))
                              ,
                            ),
                            FigText(
                              span: 
                                TextSpan(text: 'Можно до 20 фото', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.0, color: const Color(0xff7d7d7d)))
                              ,
                            ),
                          ],
                        )
                ...
                child: Row(
                  ...
                  children: [
                    FigText(
                      noWrap: true,
                      span: 
                        TextSpan(text: 'Разрешить скачивать фотографии', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.0, letterSpacing: -0.15, color: const Color(0xff85858a)))
                      ,
                    ),
                    FigBox(
                      width: 30.0,
