// GENERATED from screens/Components.bundle.js — figma node StartScreen2.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Онбординг 1 — 375.0×812.0
class Screen02Onboarding1 extends StatelessWidget {
  const Screen02Onboarding1({super.key});
        ...
        children: [
          Positioned(
            ...
            child: FigBox(
              width: 540.0,
              height: 540.0,
              bgImage: const FigBgImage('assets/figma/6b47403283623706.jpg'),
            )
          ),
          Positioned(
            left: 0.0, top: 0.0,
          ...
          Positioned(
            ...
            child: FigText(
              ...
              height: 60.0,
              span: 
                TextSpan(text: 'Сату́рн — шестая планета по удалённости от Солнца и вторая по размерам планета в Солнечной системе после Юпитера.', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 500, height: 1.333, color: const Color(0xff000000)))
              ,
            )
          ),
          Positioned(
