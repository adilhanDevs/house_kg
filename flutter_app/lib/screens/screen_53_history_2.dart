...
/// История трат · 2 — 375.0×812.0
class Screen53History2 extends StatelessWidget {
  const Screen53History2({super.key});
                        ...
                        children: [
                          Positioned(
                            ...
                            child: FigText(
                              ...
                              height: 14.0,
                              span: 
                                TextSpan(text: 'Пополнение', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe0ea812e)))
                              ,
                            )
                          ),
                        ],
