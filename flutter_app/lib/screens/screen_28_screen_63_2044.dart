// GENERATED from screens/Components.bundle.js — figma node StartScreen27.
// Do not edit by hand; regenerate with tool/generate_screens.js.
import 'package:flutter/material.dart';

import '../fig/fig.dart';

/// Экран 63:2044 — 375.0×795.0
class Screen28Screen632044 extends StatelessWidget {
  const Screen28Screen632044({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    FigText(
                      width: 335.0,
                      span: 
                        TextSpan(text: 'Добавить фото', style: figStyle(fontSize: 21.0, family: FigFont.display, weight: 600, height: 1.0, color: const Color(0xff000000)))
                      ,
                    ),
                    FigText(
                      width: 335.0,
