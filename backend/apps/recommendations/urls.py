...
urlpatterns = [
    path(
        ...
        ListingRecommendationsView.as_view(),
        name="listing-recommendations",
    ),
    path(
        "recommendations/reels/", ReelsRecommendationsView.as_view(), name="reels-recommendations"
    ),
    path(
        "recommendations/events/",
        RecommendationEventBatchView.as_view(),
