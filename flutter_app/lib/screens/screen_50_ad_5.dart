...
/// Объявление · 5 — 375.0×806.0
class Screen50Ad5 extends StatelessWidget {
  const Screen50Ad5({super.key});

  static const double designWidth = 375.0;
  static const double designHeight = 806.0;
                                        ...
                                        children: [
                                          Positioned(
                                            ...
                                            child: FigText(
                                              ...
                                              height: 14.0,
                                              span: 
                                                TextSpan(text: 'Введите значение', style: figStyle(fontSize: 12.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe07d7d7d)))
                                              ,
                                            )
                                          ),
                                        ],
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    child: FigText(
                                      ...
                                      height: 14.0,
                                      span: 
                                        TextSpan(text: 'Пополнение кошелька', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xffffffff)))
                                      ,
                                    )
                                  ),
                                ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FigText(
                                      noWrap: true,
                                      span: 
                                        TextSpan(text: 'Списать кирпичи', style: figStyle(fontSize: 13.0, family: FigFont.display, weight: 500, height: 1.077, letterSpacing: 0.065, color: const Color(0xe07d7d7d)))
                                      ,
                                    ),
                                  ],
                                )
                        ...
                        children: [
                          Positioned(
                            ...
                            child: FigText(
                              ...
                              height: 14.0,
                              span: 
                                TextSpan(text: 'Введите сумму', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 600, height: 0.933, letterSpacing: 0.075, color: const Color(0xff000000)))
                              ,
                            )
                          ),
                        ],
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FigText(
                              ...
                              height: 16.0,
                              span: 
                                TextSpan(text: '+0 Кирпичей', style: figStyle(fontSize: 15.0, family: FigFont.display, weight: 600, height: 1.0, letterSpacing: -0.15, color: const Color(0xff4dba17)))
                              ,
                            ),
                          ],
                        )
