      ...
      builder: (context, constraints) {
        ...
        return MediaQuery(
          ...
          child: Padding(
            ...
            // widthFactor вместе с heightFactor: без него Align отдаёт
            // кнопке всю ширину экрана, и она из компактной превращается в
            // полосу, а её область нажатия — в поперечную ленту поверх
            // содержимого. Оба множителя равны единице: коробка ровно по
            // размеру кнопки.
            child: Align(
